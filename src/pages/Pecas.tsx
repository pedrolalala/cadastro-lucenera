...
import { Search, MoreVertical, Edit, Trash2, Box, Plus } from 'lucide-react'
                ...
                <TableRow>
                  <TableCell colSpan={6} className="h-40 text-center">
                    <div className="flex flex-col items-center justify-center text-slate-400">
                      ...
                      <p className="text-sm">Tente ajustar seus filtros ou crie uma nova peça.</p>
                    </div>
                  </TableCell>
                </TableRow>
              ) : (
                  ...
                  <TableRow key={p.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <TableCell className="text-right">
                      <span
                        className={cn(
                          'font-medium',
                          (p.estoque_total || 0) > 0 ? 'text-emerald-600' : 'text-red-600',
                        )}
                      >
                        {p.estoque_total || 0}
                      </span>
                    ...
                    <TableCell className="text-center">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-40">
                          <DropdownMenuItem onClick={() => setActiveModal('peca', p.id)}>
